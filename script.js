(function () {
  ...
  var translations = {
    zh: {
      ...
      factContactLabel: "企业资料",
      factContactValue: "正式上线前补充",
      faqEyebrow: "FAQ · 常见问题",
      faqTitle: "出发前，先把这些问题说清楚",
      faqIntro: "具体服务范围、费用与预订条款，请以正式咨询时提供的信息为准。",
      faq1Question: "可以用中文沟通吗？",
      faq1Answer: "可以。网站与咨询流程计划提供中文和韩文沟通支持，具体方式将在正式上线时公布。",
      ...
      faq4Answer: "目前是概念预览。企业资料、联系方式、服务条款与授权图片会在正式发布前完成核对与替换。",
      contactEyebrow: "START YOUR JOURNEY",
      contactTitle: "下一段旅程，从一个想法开始",
      contactText: "先整理目的地、月份与最想体验的事。这个预览表单不会上传或保存个人信息。",
      contactNote: "正式咨询渠道将在公司资料确认后接入。",
      ...
      formResultSuffix: "。概念预览不会提交这些内容；正式上线后可在这里接入企业咨询渠道。",
      footerTagline: "把韩国旅行，写成属于你的故事。",
      footerNavigate: "快速导航",
      footerCredits: "图片来源与许可",
      footerContact: "联系信息",
      footerContactPending: "电话、邮箱与办公地址待公司确认",
      footerHoursPending: "服务时间待公司确认",
    ...
    ko: {
      ...
      factContactLabel: "회사 정보",
      factContactValue: "정식 공개 전 추가",
      ...
      faq1Answer: "네. 웹사이트와 상담 과정에서 중국어와 한국어 소통을 지원할 예정이며, 구체적인 방식은 정식 공개 시 안내합니다.",
      ...
      faq4Answer: "현재는 콘셉트 미리보기입니다. 회사 정보, 연락처, 서비스 약관과 사용 허가된 이미지는 정식 공개 전에 확인하고 교체합니다.",
      contactEyebrow: "START YOUR JOURNEY",
      contactTitle: "다음 여행은 하나의 생각에서 시작됩니다",
      contactText: "목적지, 여행 시기와 가장 기대하는 일을 먼저 정리해 보세요. 이 미리보기 양식은 개인정보를 전송하거나 저장하지 않습니다.",
      contactNote: "회사 정보 확인 후 정식 상담 채널을 연결할 예정입니다.",
      ...
      formResultSuffix: ". 콘셉트 미리보기에서는 이 내용을 전송하지 않으며, 정식 공개 후 회사 상담 채널과 연결할 수 있습니다.",
      footerTagline: "한국 여행을 나만의 이야기로 써 내려갑니다.",
      footerNavigate: "바로가기",
      footerCredits: "사진 출처 및 라이선스",
      footerContact: "연락처",
      footerContactPending: "전화, 이메일과 사무실 주소 확인 중",
      footerHoursPending: "상담 시간 확인 중",
